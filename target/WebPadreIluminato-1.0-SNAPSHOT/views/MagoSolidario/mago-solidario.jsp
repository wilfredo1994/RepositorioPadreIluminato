<%-- 
    Document   : mago-solidario
    Created on : 18/06/2024, 11:03:33 PM
    Author     : ROCIO
--%>
        ...
        <section class="page-section bg-light pt-5 pb-5 mb-0" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="text-center text-uppercase mb-5">Voluntariado</h2>
                </div>
                <!-- * * * * * * * * * * * * * * *-->
                    ...
                    <div class="col-md-6">
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <!-- an error submitting the form-->
                                ...
                                <!-- Submit Button-->
                                <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase disabled" id="submitButton" type="submit">Donar</button></div>
                        </form>
                    </div>
                    <div class="col-md-6 text-center">
                        <img class="img-fluid rounded" src="content/assets/img/voluntariado/1.jpg" alt="..." />
                    </div>
                </div>
            </div>
        </section>
